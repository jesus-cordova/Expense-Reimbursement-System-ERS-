...
@WebServlet("/manager/reimbursements")
public class ManagerReimbursementRequest extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			String json = new Gson().toJson(mngr.viewEmployeeReimbursementRequest(empID));
			out.print(json);
