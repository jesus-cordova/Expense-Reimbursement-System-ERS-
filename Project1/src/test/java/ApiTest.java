...
public class ApiTest {
	...
	public void testEmployeeExist() throws SQLException {
		Employee emp1  = new Employee(1, "Drew", "Joshua", "drew@email.com", "801-888-8888");
		Employee  employee = emp.validateEmloyeeLogin("drew@email.com", "josh");
	...
	public void testEmployeeSettings() throws SQLException {
		...
		assertEquals(employee.getEmail(), "drew@email.com");
	}
	@Test
